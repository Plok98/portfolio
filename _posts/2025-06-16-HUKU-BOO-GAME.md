...
author: palferink
paginate: true
modal-id: HUKU-BOO-GAME
img: huku_boo/header.png
thumbnail: huku_boo/header.png
alt: Game - HUKU BOO
project-date: 2025-06-16
client: Start-up
---
...
<div class="image-grid">
  <figure>
    <video width="500" controls>
      <source src="{{ site.baseurl }}/img/portfolio/huku_boo/aboutHUKU.MP4" type="video/mp4">
      Je browser ondersteunt geen video.
    </video>
    <figcaption>Introductievideo: een korte uitleg over HUKU BOO en zijn avontuur.</figcaption>
  </figure>
  <figure>
    <img src="{{ site.baseurl }}/img/portfolio/huku_boo/header.png" alt="Headerbeeld HUKU BOO">
    <figcaption>De headerafbeelding met HUKU BOO, het spookje dat centraal staat in de game.</figcaption>
  </figure>
  <figure>
    <img src="{{ site.baseurl }}/img/portfolio/huku_boo/HukuBoo_Poster_SFD.jpg" alt="Poster HUKU BOO game">
    <figcaption>De officiële poster van HUKU BOO, gebruikt als promotiemateriaal voor de game.</figcaption>
  </figure>
  <figure>
    <video width="500" controls>
      <source src="{{ site.baseurl }}/img/portfolio/huku_boo/theGame.mp4" type="video/mp4">
      Je browser ondersteunt geen video.
    </video>
